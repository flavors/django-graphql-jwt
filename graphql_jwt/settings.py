...
class JWTSettings(object):
    ...
    def user_settings(self):
        if not hasattr(self, '_user_settings'):
            ...
            if self.user_settings.get('JWT_PUBLIC_KEY', self.defaults['JWT_PUBLIC_KEY']) is None:
                self._user_settings['JWT_PUBLIC_KEY'] = self.user_settings.get('JWT_SECRET_KEY', self.defaults['JWT_SECRET_KEY'])
